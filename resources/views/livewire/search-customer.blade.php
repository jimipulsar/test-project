    ...
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        ...
        <div
            ...
            <table class="min-w-full">
                <thead>
                <tr>
                    <th style="width:200px; cursor:pointer" wire:click.prevent="sortBy('billing_name')"
                ...
                @foreach ($customers as $customer)
                    <tr>
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div
                                    class="leading-5 text-gray-900 ">{{ $customer->billing_name }} {{ $customer->billing_surname }}</div>

                        </td>
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div
                                    class="leading-5 text-gray-900 ">{{ $customer->email }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-center justify-content-center">
                            <a data-toggle="tooltip" data-placement="bottom"
                               ...
                               title="Visualizza"
                               href="{{ route('customers.show', $customer->id) }}" id="btLeft"><i
                                                ...
                                                <div class="md:flex sm:items-start py-3">
                                                    ...
                                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                        <h3 class="text-lg leading-6 font-medium text-gray-900"
                                                            ...
                                                            <br><strong>{{ $customer->billing_name }}</strong> ?
                                                        </h3>
                                                        <div class="mt-2">
                                                            <p class="text-sm text-gray-500">
                                                                È possibile annullare un ordine solo se non è stato
                                                                ancora spedito. Questa azione è irreversibile.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
