    ...
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        ...
        <div class="my-4">
            <p class="text-sm text-gray-700 leading-5">
                ...
                <span class="font-medium">{{ $archivedUsers->firstItem() }}</span>
                <span>{!! __('to') !!}</span>
                <span class="font-medium">{{ $archivedUsers->lastItem() }}</span>
                <span>{!! __('of') !!}</span>
                <span class="font-medium">{{ $archivedUsers->total() }}</span>
            ...
            <table class="min-w-full">
                ...
                <tr>
                    ...
                    <th style="width:150px"
                        class="text-right pr-20 px-6 py-3 border-b border-gray-200 bg-gray-50 text-center text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                        Created at
                    </th>
                </tr>
                </thead>
                ...
                @foreach ($archivedUsers as $user)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-right">
                            <div
                                    class="leading-5 text-gray-900 ">{{ $user->created_at }}</div>
        ...
        <div class="d-flex justify-content-center mt-5 mb-5">
            {{ $archivedUsers->links('vendor.pagination.tailwind') }}
